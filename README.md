...
A collection of Python scripts for managing and analyzing concert attendance data.
...
Each script can be run independently. See individual script documentation for specific usage instructions. 